        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form  id="FormContainer">
                    ...
                    <div class="row">                                                
                        <div class="col-md-12">
                           <a class="btn btn-primary btn-block btn-primary verdeExaudi" id="btnLoguin" href="?Page=Screen1">Ingresar con Facebook</a>
                        </div>                      
                    </div>
                    <br>
                    <div class="row">                        
                        <!-- /.col -->
                        <div class="col-md-12">
                            <a class="btn  btn-block btn-default" id="btnLoguin" href="?Page=Screen1">Ingresar sin identificarse</a>
                        </div>
